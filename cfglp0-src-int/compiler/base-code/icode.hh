...
public:
  Mem_Addr_Opd(Symbol_Table_Entry & se, Data_Type _data_type);
  ~Mem_Addr_Opd() {}
...
public:
  Stack_Mem_Addr_Opd(Symbol_Table_Entry & se, Data_Type _data_type, int _stack_offset);
  ~Stack_Mem_Addr_Opd() {}
...
public:
  Register_Addr_Opd(Register_Descriptor * rd, Data_Type _data_type);
  ~Register_Addr_Opd() {}
...
public:
  Const_Opd (T num, Data_Type _data_type);
  ~Const_Opd() {}
...
class Set_Unary_Rel_IC_Stmt: public Icode_Stmt
{ 
  Ics_Opd * opd1;   
  Ics_Opd * result; 

public:
  Set_Unary_Rel_IC_Stmt(Tgt_Op inst_op, Ics_Opd * opd1, Ics_Opd * result); 
  ~Set_Unary_Rel_IC_Stmt() {} 
  Set_Unary_Rel_IC_Stmt & operator=(const Set_Unary_Rel_IC_Stmt & rhs);
...
class Call_IC_Stmt: public Icode_Stmt
{
  ...
  int size;
public:
  Call_IC_Stmt(string _name, int _size);
  void print_icode(ostream & file_buffer);
  void print_assembly(ostream & file_buffer);
};

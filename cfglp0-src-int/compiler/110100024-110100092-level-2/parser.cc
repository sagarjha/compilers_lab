// Generated by Bisonc++ V2.09.03 on Tue, 25 Mar 2014 00:29:28 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {300, 3}, // 15: basic_block (BBNUM) ->  BBNUM ':' executable_statement_list
     {300, 4}, // 16: basic_block (BBNUM) ->  BBNUM ':' executable_statement_list conditional_statement
     {300, 4}, // 17: basic_block (BBNUM) ->  BBNUM ':' executable_statement_list goto_statement
     ...
     {303, 4}, // 22: assignment_statement (ASSIGN) ->  variable ASSIGN flp ';'
     {304, 1}, // 23: variable (NAME) ->  NAME
     {305, 1}, // 24: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {306, 11}, // 25: conditional_statement (IF) ->  IF '(' flp ')' GOTO BBNUM ';' ELSE GOTO BBNUM ';'
     {307, 3}, // 26: goto_statement (GOTO) ->  GOTO BBNUM ';'
     {308, 1}, // 27: modified_variable ->  variable
     {308, 1}, // 28: modified_variable ->  constant
     {309, 3}, // 29: flp (ASSIGN) ->  flp ASSIGN slp
     {309, 1}, // 30: flp ->  slp
     {310, 3}, // 31: slp (EQUAL) ->  slp EQUAL tlp
     {310, 3}, // 32: slp (NOT_EQUAL) ->  slp NOT_EQUAL tlp
     {310, 1}, // 33: slp ->  tlp
     {311, 3}, // 34: tlp (GE) ->  tlp GE tlt
     {311, 3}, // 35: tlp (GT) ->  tlp GT tlt
     {311, 3}, // 36: tlp (LE) ->  tlp LE tlt
     {311, 3}, // 37: tlp (LT) ->  tlp LT tlt
     {311, 1}, // 38: tlp ->  tlt
     {312, 1}, // 39: tlt ->  modified_variable
     {312, 3}, // 40: tlt ('(') ->  '(' flp ')'
     {313, 1}, // 41: program_$ ->  program
};
...
{
    { { REQ_DEF}, {  6} },                                      
    { {     295}, { 16} }, // optional_variable_declaration_list
    { {     296}, { 17} }, // variable_declaration_list         
    { {     297}, {  4} }, // variable_declaration              
    { {     298}, {  5} }, // declaration                       
    { {     261}, {  6} }, // INTEGER                           
    { {       0}, { -7} },                                      
...
{
    { { DEF_RED}, {   3} },                             
    { {     301}, {  25} }, // executable_statement_list
    { {     302}, {  26} }, // assignment_statement_list
    { {       0}, { -20} },                             
};
...
{
    { { REQ_DEF}, {   5} },                         
    { {     306}, {  27} }, // conditional_statement
    { {     307}, {  28} }, // goto_statement       
    { {     262}, {  29} }, // IF                   
    { {     264}, {  30} }, // GOTO                 
    { {       0}, { -15} },                         
};
...
SR__ s_35[] =
{
    ...
    { {       311}, { 41} }, // tlp              
    { {       312}, { 42} }, // tlt              
    { {       308}, { 43} }, // modified_variable
    { {        40}, { 44} }, // '('              
    { {       304}, { 45} }, // variable         
    { {       305}, { 46} }, // constant         
    { {       259}, { 34} }, // NAME             
    { {       257}, { 47} }, // INTEGER_NUMBER   
    { {         0}, {  0} },                     
};
...
void Parser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        case 16:
        {
         ...
         d_val__.basic_block = new Basic_Block(d_vsp__[-3].integer_value, get_line_number());
         d_val__.basic_block->set_ast_list(*d_vsp__[-1].ast_list);
         }
         else
         {
         list<Ast *> * ast_list = new list<Ast *>;
         ...
         d_val__.basic_block = new Basic_Block(d_vsp__[-3].integer_value, get_line_number());
         d_val__.basic_block->set_ast_list(*ast_list);
         }
        ...
        case 25:
        {
         if (NOT_ONLY_PARSE)
         {
         max_goto_bb_num = max (max_goto_bb_num, d_vsp__[-5].integer_value);
         max_goto_bb_num = max (max_goto_bb_num, d_vsp__[-1].integer_value);
         d_val__.ast = new Conditional_Ast (d_vsp__[-8].ast, d_vsp__[-5].integer_value, d_vsp__[-1].integer_value, get_line_number());
         }
         }
        break;
        ...
        case 29:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast (d_vsp__[-2].ast, nop, d_vsp__[0].ast, get_line_number());
        ...
        case 31:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast (d_vsp__[-2].ast, seq, d_vsp__[0].ast, get_line_number());
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 32:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast (d_vsp__[-2].ast, sne, d_vsp__[0].ast, get_line_number());
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 34:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast (d_vsp__[-2].ast, sge, d_vsp__[0].ast, get_line_number());
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 35:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast (d_vsp__[-2].ast, sgt, d_vsp__[0].ast, get_line_number());
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 36:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast (d_vsp__[-2].ast, sle, d_vsp__[0].ast, get_line_number());
         d_val__.ast->check_ast();
         }
         }
        break;
        ...
        case 37:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast (d_vsp__[-2].ast, slt, d_vsp__[0].ast, get_line_number());
         d_val__.ast->check_ast();
         }
         }
        break;

...
void Conditional_Ast::print_successors (ostream & file_buffer)
{
  ...
  file_buffer << endl << AST_NODE_SPACE << "False Successor: " << bb_id2;
}
...
Eval_Result & Conditional_Ast::evaluate(Local_Environment & eval_env, ostream & file_buffer)
{
  ...
  file_buffer << endl << AST_SPACE << "Condition " << ((predicate_value.get_value()==0)?"False":"True") << " : Goto (BB " << successor << ")" << endl;
...
void Goto_Ast::print_ast (ostream & file_buffer)
{
  ...
  file_buffer << endl << AST_NODE_SPACE << "Successor: " << bb_id;
}

Eval_Result & Goto_Ast::evaluate(Local_Environment & eval_env, ostream & file_buffer)
{
  print_ast (file_buffer);
  file_buffer << endl << AST_SPACE << "GOTO (BB " << bb_id << ")" ;
